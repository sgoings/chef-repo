...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "sgoings-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/sgoings"
  #   chef.validation_client_name = "sgoings-validator"
  #   chef.validation_key_path = ".chef/sgoings-validator.pem"
  # end
end
